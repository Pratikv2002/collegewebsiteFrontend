...
function Home() {
  ...
  return (
    <div>
        ...
        <div onClick={()=>{navigate("/googleMap")}} className = "px-5 py-3 rounded-left" style={{position:'absolute',backgroundColor:"white",right:0,border:"solid 2px blue",borderTopLeftRadius:"10px",borderBottomLeftRadius:"10px"}}><svg color='blue' xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
